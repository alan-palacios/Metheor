...
{
          public static void GenerateObjects(ref GameObject[][] objetos, ObjectPlacingList objectPlacingList,
          ...
          public static void DeleteObjects( ref GameObject displayedObjectsParent){
