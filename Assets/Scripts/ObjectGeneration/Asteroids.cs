...
public class Asteroids : MonoBehaviour
{
    ...
    void Start(){
              ...
              Material material = asteroidsConfiguration.materials[ Random.Range(0, asteroidsConfiguration.materials.Length)];
              ...
              for (int i = 0; i<numOfAsteroids; i++) {
                        ...
                        asteroids[i].GetComponent<Renderer>().material = material;
